...
Low $\Lambda \approx 0.16$: Spectral effect at $\ell > 2000$\\
ACT sees it, Planck cannot\\[0.5em]
High $\Lambda \approx 0.8$: Geometric effect at $\ell < 1500$\\
Planck sees it, ACT doesn't benefit
\vspace{3cm}}}
\caption{Schematic of the two EDE regimes. \emph{Left:} Low $\Lambda \approx 0.16$ 
produces a spectral ``soft shoulder'' concentrated at $\ell > 2000$, 
which ACT detects but Planck cannot resolve. \emph{Right:} High $\Lambda \approx 0.8$ 
produces a geometric sound-horizon shift visible at $\ell < 1500$, 
...
\end{tabular}
\end{center}
The relationships: physical EDE captures 95\% of the template improvement 
while respecting additional constraints; the fixed-geometry test shows the 
preference is internal to ACT spectra.
