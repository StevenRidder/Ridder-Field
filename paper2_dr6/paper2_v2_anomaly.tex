...
while BAO and supernovae remain neutral. Probability-to-exceed tests ($P < 10^{-4}$ 
from 10,000 simulations), phase-scrambling checks (7.5$\sigma$ coherence), and 
frequency-split analyses (achromatic across 90--150~GHz) confirm this is not a 
statistical fluctuation or foreground contamination.
...
\item Robustness: PTE ($P < 10^{-4}$), phase coherence (7.5$\sigma$), 
achromaticity (90/150~GHz consistent).
