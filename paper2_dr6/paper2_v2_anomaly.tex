...
The ACT-preferred EDE model yields a sound horizon approximately 1\% 
smaller than the \lcdm\ prediction. This shift is driven by ACT's 
high-$\ell$ data; Planck+DESI does not prefer it.
