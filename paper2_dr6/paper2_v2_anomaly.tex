...
while BAO and supernovae remain neutral. Monte Carlo simulations (10,000 
mock ACT realizations) yield $P < 10^{-4}$ for the observed amplitude under 
\lcdm; shifted-template tests confirm phase-specificity; frequency splits 
show achromaticity at 90--150~GHz.
...
shifted-template tests confirm phase-specificity; frequency splits show 
...
\item Robustness: Monte Carlo (10,000 sims, $P < 10^{-4}$), shifted-template 
test (phase-specific), frequency splits (achromatic at 90/150~GHz).
