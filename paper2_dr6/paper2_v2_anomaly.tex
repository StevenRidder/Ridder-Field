...
(8.1$\sigma$), with $\Delta\chi^2 \approx -770$ relative to pure \lcdm\ and the 
...
$\Delta\chi^2 \approx -770$ relative to \lcdm. This signal is internal to ACT: 
...
for the ACT+DESI combination, localized almost entirely to the damping tail. When 
...
Both criteria decisively favor EDE over \lcdm\ for the ACT+DESI combination. 
...
the beam, one is effectively fitting noise fluctuations. This is why a 
$\chi^2$ penalty in Planck's high-$\ell$ regime is expected on resolution 
grounds, independent of the underlying cosmology. We emphasize that this 
...
\item $\chi^2$ improvement: $\Delta\chi^2 \approx -770$ relative to \lcdm
