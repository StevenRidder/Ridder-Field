...
The ``so what'' of this paper is not ``here is a quirky early dark energy 
model.'' It is that small-scale CMB data already force a binary choice between 
new pre-recombination physics and a specific class of ACT systematics---and we 
show exactly what that choice looks like and how to test it.
...
The ``so what'' is that the cosmological model is no longer only in tension 
...
The ``so what'' is not a quirky model, but a roadmap: here is the exact 
signature, here is the required precision, here is how many sigma you expect 
under each hypothesis. The test is falsifiable and imminent.
