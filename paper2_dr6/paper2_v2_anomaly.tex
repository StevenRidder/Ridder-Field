...
mock ACT realizations) yield $P < 10^{-4}$ for the observed amplitude; 
phase-scrambling tests show 10.5$\sigma$ coherence; frequency splits 
confirm achromaticity at 90--150~GHz.
...
\item Robustness: Monte Carlo (10,000 sims, $P < 10^{-4}$), phase scrambling 
(10.5$\sigma$ coherence), frequency splits (achromatic at 90/150~GHz).
