...
tests ($P < 10^{-5}$), phase-scrambling checks, and frequency-split analyses (the 
feature is achromatic across 90--150~GHz) confirm this is not a statistical 
fluctuation or foreground contamination.
...
phase scrambling confirms coherence; frequency splits show achromaticity at 90/150~GHz.
\end{enumerate}
...
(Figure~\ref{fig:freq_achromaticity}):
\begin{center}
\begin{tabular}{lccc}
\toprule
Frequency & $\Lambda_{\rm EDE}$ & $\chi^2_{\rm min}$ & CIB expectation \\
\midrule
...
\item \textbf{Robustness}: Probability-to-exceed tests ($P < 10^{-5}$), 
phase-scrambling analyses (13.4$\sigma$), and frequency-split tests 
(consistent $\Lambda_{\rm EDE}$ at 90/150~GHz) confirm that the ACT feature is 
neither a statistical fluctuation nor foreground contamination.
\end{enumerate}
