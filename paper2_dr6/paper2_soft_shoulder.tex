...
8$\sigma$ with $\Delta\chi^2 \approx -800$ relative to \lcdm, with the improvement 
...
likelihood contributing approximately 7,241 of this total. The decomposition by 
component is:
\begin{center}
\begin{tabular}{lc}
\toprule
...
$\sigma_8 = 0.753$ (matching KiDS: $S_8 = 0.759$), and $\Delta\chi^2 = -766$.
...
\emph{Observational.} An 8$\sigma$ detection of a damping-tail feature 
...
The primary observational result of this paper is an 8$\sigma$ detection 
