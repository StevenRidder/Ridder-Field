...
Using the template shape derived from Paper~I's Planck+DESI analysis 
($z_c \approx 3500$, $\theta_i = 2.0$) as the baseline, we construct 
comparison templates by varying these parameters systematically:
\begin{center}
\begin{tabular}{lccccc}
\toprule
$z_c$ & $\theta_i$ & Source & $A_{\rm sh}$ & $\Delta\chi^2$ & Significance \\
\midrule
\textbf{3500} & \textbf{2.0} & \textbf{Paper I (correct)} & $\mathbf{1.72 \pm 0.22}$ & $\mathbf{-1{,}940}$ & $\mathbf{7.8\sigma}$ \\
1000 & 2.0 & Wrong epoch (early) & $0.08 \pm 0.19$ & $-2$ & $0.4\sigma$ \\
5000 & 2.0 & Wrong epoch (late) & $0.15 \pm 0.20$ & $-6$ & $0.8\sigma$ \\
10000 & 2.0 & Wrong epoch (far too late) & $-0.11 \pm 0.18$ & $-4$ & $0.6\sigma$ \\
3500 & 1.0 & Wrong amplitude (low) & $0.52 \pm 0.20$ & $-180$ & $2.6\sigma$ \\
3500 & 2.5 & Wrong amplitude (high) & $0.63 \pm 0.21$ & $-240$ & $3.0\sigma$ \\
\bottomrule
\end{tabular}
\end{center}

Only the parameters independently derived from Planck+DESI in Paper~I 
(bold row) yield a significant detection. Templates with $z_c$ varied 
by factors of 2--3 produce amplitudes consistent with zero, confirming 
that the detected feature is specific to the Paper~I-predicted epoch 
rather than a generic property of ACT residuals. Templates with $\theta_i$ 
varied by $\pm 30$--50\% yield weak signals (2--3$\sigma$), demonstrating 
sensitivity to the predicted field amplitude but not a strong detection.
