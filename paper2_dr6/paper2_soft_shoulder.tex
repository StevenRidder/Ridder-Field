...
statistically unchanged. Our analysis differs from the primary ACT DR6 cosmological 
analysis in that we apply a fixed, EDE-motivated matched filter in the damping tail, 
rather than restricting to the standard \lcdm\ parameter space, which increases 
sensitivity to this specific phase-coherent pattern.
