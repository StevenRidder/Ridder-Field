...
This paper was developed with substantial assistance from AI tools (Claude, Anthropic). The AI contributed to literature review, mathematical derivations, code development for the CLASS/Cobaya implementation, statistical analysis, figure generation, and manuscript drafting. All scientific direction, hypothesis formulation, result interpretation, and final editorial decisions were made by the author. The author takes full responsibility for the content and any errors.
