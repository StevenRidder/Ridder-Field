...
The modified CLASS implementation, Cobaya configuration files, analysis scripts, and MCMC chains supporting this work are available at \url{https://github.com/StevenRidder/Ridder-Field} and permanently archived at Zenodo: \url{https://doi.org/10.5281/zenodo.XXXXXXX} (DOI to be assigned upon publication).
