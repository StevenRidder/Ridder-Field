...
ridder_files = sorted(glob.glob('../phase2/class/output/final_run_*_pk.dat'), key=os.path.getmtime)
...
ax1.set_title('Matter Power Spectrum (With Gauge Artifact)', fontsize=16, fontweight='bold')
...
ax2.set_title('Growth Ratio (Shows low-k contamination)', fontsize=14)
...
plt.tight_layout()
plt.savefig('final_pk_comparison.png', dpi=300)
print("✅ Plot saved: final_pk_comparison.png")
