...
struct background
{
  ...
  double z_w_transition; /**< redshift below which w deviates from -1 */
  ...
  enum scf_potential_type scf_potential; /**< type of scalar field potential */
  ...
  double xi_late;            /**< Late-time DM-DE coupling strength (only active z<10) */
  ...
  int index_bg_phi_ridder;       /**< Ridder field value */
  ...
  int index_bi_phi_ridder;       /**< {B} Ridder field value */
  int index_bi_phi_prime_ridder; /**< {B} Ridder field derivative wrt conformal time */
