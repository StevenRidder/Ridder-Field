...
By contrast, the $\phi$-field solution already lives in the $H_0 \simeq 70$, $r_s \simeq 146$~Mpc region. Its DESI-inclusive penalty of $\Delta\chi^2 \simeq +11$ should therefore be interpreted as the price of entering that region, not as a sign of internal inconsistency. At fixed $H_0 \simeq 70$, Geometric EDE is \emph{less expensive} than $\Lambda$CDM in $\chi^2$ and simultaneously improves $S_8$. If the late-time data continue to favor the convergence window, this fixed-$H_0$ comparison becomes as relevant as the traditional global-minimum comparison.
